...
const IdentityCardPage = () => {
  ...
  return (
    <div className="data-section">
      ...
      <div className="flex justify-between bg-white mt-5 pl-7 rounded-b-[20px] text-[#0F7EF5] w-full h-full font-semibold uppercase leading-5 text-[14px] items-center p-5">
